...
import 'package:forelsket/UI/Profile/Screen/profile_screen.dart';
...
import 'package:forelsket/UI/Profile/widgets/large_button.dart';
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Image.asset(
              'assets/facebook_ui/background/header_Icon_white.png',
            ),
          ),
          // CircleButton(
          //   callback: () => debugPrint('Forelsket'),
          //   icon: FittedBox(
          //     fit: BoxFit.fitWidth,
          //     // child: Image.asset(
          //     //   'assets/facebook_ui/background/header_Icon_white.png',
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                ClipOval(
                  child: Hero(
                    tag: "${FirebaseAuth.instance.currentUser!.photoURL}",
    ...
    return Row(
      ...
      children: [
        ...
        LargeButton(
          ...
          callback: () => debugPrint('Short video'),
          text: 'Short video',
          icon: const FaIcon(
